...
genes <- c("NEDD9","TWIST1","HIF1A","EPAS1", "AKT3", "BCL2A1", "BIRC5", "BUB1", "C1orf90", "CDC45L", "CDC6", 
...
hist(mat.uvm.expr$met_score_mel)
...
pdf("./Figures/TCGA_SKCM_UVM_metscore_mel_boxplot.pdf", w=8, h=6)
ggplot(metscore, aes(x=cohort, y=met_score_mel)) + 
    geom_boxplot() +
...
metscore.anova <- aov(met_score_mel~cohort,  data=metscore)
summary(metscore.anova)

compare <- data.frame(c1=c("SKCM TP","SKCM TP","SKCM TM"), c2=c("SKCM TM","UVM","UVM"), pval=NA)
compare[1,3] <- t.test(tp.skcm.metscore$met_score_mel, tm.skcm.metscore$met_score_mel)$p.value
compare[2,3] <- t.test(tp.skcm.metscore$met_score_mel, uvm.metscore$met_score_mel)$p.value
compare[3,3] <- t.test(tm.skcm.metscore$met_score_mel, uvm.metscore$met_score_mel)$p.value
...
ggplot(tp.skcm.metscore.stage, aes(x=stage, y=met_score_mel, fill=stage)) + 
    scale_fill_manual(values=colors4) +
    geom_boxplot() +
...
ggplot(tm.skcm.metscore.stage, aes(x=stage, y=met_score_mel, fill=stage)) + 
    scale_fill_manual(values=colors4) +
    geom_boxplot() +
...
ggplot(uvm.metscore.stage, aes(x=stage, y=met_score_mel, fill=stage)) + 
    geom_boxplot() +
...
# Anova
tp.skcm.metscore.stage.anova <- aov(met_score_mel~stage,  data=tp.skcm.metscore.stage)
summary(tp.skcm.metscore.stage.anova)

tm.skcm.metscore.stage.anova <- aov(met_score_mel~stage,  data=tm.skcm.metscore.stage)
summary(tm.skcm.metscore.stage.anova)

uvm.metscore.stage.anova <- aov(met_score_mel~stage,  data=uvm.metscore.stage)
...
ggplot(tp.skcm.metscore.stage, aes(x=earlyLate, y=met_score_mel, fill=earlyLate)) + 
    scale_fill_manual(values=colors4) +
    geom_boxplot() +
...
ggplot(tm.skcm.metscore.stage, aes(x=earlyLate, y=met_score_mel, fill=earlyLate)) + 
    scale_fill_manual(values=colors4) +
    geom_boxplot() +
...
ggplot(uvm.metscore.stage, aes(x=earlyLate, y=met_score_mel, fill=earlyLate)) + 
    geom_boxplot() +
    scale_fill_manual(values=colors4) +
...
t.test(tp.skcm.metscore.stage.early$met_score_mel, tp.skcm.metscore.stage.late$met_score_mel)
...
t.test(tm.skcm.metscore.stage.early$met_score_mel, tm.skcm.metscore.stage.late$met_score_mel)
...
t.test(uvm.metscore.stage.early$met_score_mel, uvm.metscore.stage.late$met_score_mel)